...
function call_all_apis() {
    ...
    //Retrieve the most popular products from all categories
    Promise.all([
        // Amazon
        fetch(`https://rapidapi.p.rapidapi.com/product/search?keyword=*&page=${general_page_num}&category=aps&country=SG`, {
            "method": "GET",
            "headers": {
        ...
        fetch(`https://rapidapi.p.rapidapi.com/api/bestSales/products?page=${general_page_num}&sort=LAST_VOLUME_ASC&targetCurrency=USD&lg=EN`, {
            "method": "GET",
            "headers": {
        ...
        // Taobao Advanced
        fetch(`https://rapidapi.p.rapidapi.com/api?api=item_search_tejia&page=${general_page_num}&priceScope=1-9999`, {
            "method": "GET",
            "headers": {
        ...
        var amazon_json = data[0].products;
        var ali_json = data[1].docs;
        ...
        .then(response =>{
            ...
            collated_list = sort_list_by(collated_list, "relative_popularity");
